...
class Identifiers(Base):
    ...
    def formatType(self):
        ...
        elif format_type == "fidibo":
            return u"فیدیبو"
        elif format_type == "taaghche":
            return u"طاقچه"
        elif format_type == "ketabrah":
            return u"کتابراه"
        elif format_type == "nlai":
            return u"کتابخانه ملی"
        elif format_type == "fidibo-ab":
            return u"فیدیبو صوتی"
        elif format_type == "taaghche-ab":
            return u"طاقچه صوتی"
        elif format_type == "ketabrah-ab":
            return u"کتابراه صوتی"
        elif format_type == "navaar":
            return u"نوار"
        else:
            return self.type
    ...
    def __repr__(self):
        ...
        elif format_type == "fidibo" or format_type == "fidibo-ab":
            return u"https://fidibo.com/book/{0}".format(self.val)
        elif format_type == "taaghche" or format_type == "taaghche-ab":
            return u"https://taaghche.com/book/{0}".format(self.val)
        elif format_type == "ketabrah" or format_type == "ketabrah-ab":
            return u"http://ktbr.ir/b{0}".format(self.val)
        elif format_type == "nlai":
            return u"http://opac.nlai.ir/opac-prod/bibliographic/{0}".format(self.val)
        elif format_type == "navaar":
            return u"https://www.navaar.ir/audiobook/{0}".format(self.val)
